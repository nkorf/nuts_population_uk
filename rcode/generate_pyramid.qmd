---
title: "NUTS Population Pyramids"
format: html
editor: visual
---
...
plotdata$age_band <- factor(plotdata$age_band,levels = levels(plotdata$age_band),labels=levels_format)
```
